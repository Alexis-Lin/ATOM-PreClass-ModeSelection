...
- **「让 ATOM 就在你的手边」** 柔性提醒（手机测不到距离，只做提醒不硬卡）。

**Live Coach（对角度较敏感）**
- **这样摆**：全身入框（动作最大幅度也不出框）/ 手机稳定约胸口高镜头水平 / 光线均匀别逆光 / 画面干净只有你。
- **这些会让识别变不准**：肢体被裁切或遮挡 / 太近太远 / 倾斜过高过低 / 逆光反光过暗 / 有他人或杂物入镜。
...
**ATOM 端**：**独立整屏**（不透明、无蒙层），带取景图 + 按模式的精简两句（Coach：Beta + 完整入框；Recap：全程在画面里 + 报告迭代），可 **×** 关闭、可勾选 **不再显示**。
