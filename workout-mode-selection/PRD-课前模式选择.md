...
启动任一 **AI 模式**先弹「开始前，摆好画面」——把「怎样算摆好」和「哪些情况会让识别变不准」讲清楚，管理准确度预期（Manual Log 无摄像头，不弹）。

- **取景示意图**：一个人完整站在手机取景框内、脚踩地面线、四周留安全边距（火柴人为占位，正式版待设计师出「正确 vs 错误」对照插画）。
- **「这样摆」正向清单**：全身入框 / 手机稳定平放约与胸口同高且水平 / 光线充足避免逆光 / 画面干净只有你。
- **「这些会让识别变不准」负向清单**：肢体被裁切或被器械·宽松衣物遮挡 / 距离太近太远 / 镜头倾斜过高过低 / 强逆光反光过暗 / 画面里有他人或杂物。
- **Beta 提示** + 取消 / 准备好了。
- **ATOM 端**：**独立整屏**（不透明、无蒙层），同样带取景示意图 + 精简两句，可 **×** 关闭、可勾选 **不再显示**。
